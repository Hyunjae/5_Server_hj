...
<body>
    ...
    <pre>
        JSP에서 자주 사용되거나 공통적으로 사용되는 Java 코드의 
    ...
    <ol>
        ...
        <li>webapp/WEB-INF/lib 폴더에 추가하기(복사&붙여넣기 : 웹 프로젝트에서 lib 추가 방식)</li>
    </ol>
	...
	<pre>
		...
		- c:set 속성
		1) var   : 변수명(setAtrribute의 key 값)
		2) value : 대입될 값 
		3) scope : 내장 객체의 범위(기본값 : page)
	...
	<h1>4. 조건문 - if ~ else if ~ else ( c:choose )</h1>
