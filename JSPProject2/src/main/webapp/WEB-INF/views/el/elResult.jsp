...
<body>
    ...
    <pre>
        ...
        *list3 : null은 아니지만 비어있음
       	...
       	list eq null : ${list3 eq null}
       	empty list3 : ${empty list3}
    
    	list3에 요소가 추가되어 있는가?(비어있지 않은가)	${!empty list3}
    	list3에 요소가 추가되어 있는가?(비어있지 않은가)	${not empty list3}
    
    	*list4 : null도 아니고, 요소도 1개 추가 되어있음
        
       	list eq null : ${list4 eq null}
       	empty list4 : ${empty list4}
    
    	list3에 요소가 추가되어 있는가?	${!empty list4}
    	list3에 요소가 추가되어 있는가?	${not empty list4}
