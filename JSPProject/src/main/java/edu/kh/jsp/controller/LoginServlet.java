...
//		
		...
		// 요청 : 로그인 요청이 왔을 때 결과 화면을 만드는 것 위임
		// /WEB-INF/views/loginResult.jsp 주소의 jsp에게 요청을 위임하는 것
		...
		// - forward는 페이지 이동이 아닌 servlet의 역할 중
		//   응답화면 출력 역할을 분업한 JSP에게 req, resp를 전달만하는 것
		// -> JSP가 응답을 대신 할 뿐이다
