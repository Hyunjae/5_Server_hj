...
COMMENT ON COLUMN "BOARD"."BOARD_DEL_FL" IS '삭제여부(N: 삭제 X, Y: 삭제 O)';
...
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user03@kh.or.kr', 'pass03!',
	'유저이3', '01022222222', '04540,,서울시 중구 남대문로 120,,3층',
	DEFAULT, DEFAULT, DEFAULT, DEFAULT
);
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$W.frUM5J3JtoIsen.ur9zeg7yqAP43NjWtDKTkVtbUS8DBV/CHNjy';
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board','20221116105843_00001.gif', '1.gif', 0, 1998);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board','20221116105843_00002.gif', '2.gif', 0, 1995);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board','20221116105843_00003.gif', '3.gif', 0, 1994);

INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board','20221116105843_00004.gif', '4.gif', 0, 1993);


-- BOARD_LIKE 테이블 샘플데이터 삽입
SELECT * FROM BOARD_LIKE;

INSERT INTO BOARD_LIKE VALUES(1998,1);
...
-- 댓글 샘플데이터
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT,1998 ,1, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT,1998 ,2, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT,1998 ,1, 2002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT,1998 ,3, 2002);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT,1998 ,4, 2002);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT,1998 ,10, 2003);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT,1998 ,1, 2003);
COMMIT;
...
(참고) INLINE뷰로 만들고 level, c.*로 조회하면 여러번 대댓글도 확인 가능
